<template>
	<view class="playlist">
		...
		<minmusic v-show="xian" :imgk="musicpic" :name="name" :ren="ren" :dd="dd" :top="topnum" :startk="startk"
			:endk="endk" :musiclength="musiclength" :musicvalue="musicvalue" :few="few" :playlength="playlength"
			:hello="hello" @stop="okstop" @stopkk="bilibili" @xianok="okxian" ref="child"></minmusic>
	</view>
</template>
				...
				if (this.songdata === null || this.getk == 1) {
					...
					uni.request({
						...
						success: (res) => {
							...
							// console.log(res.data.playlist.shareCount)
