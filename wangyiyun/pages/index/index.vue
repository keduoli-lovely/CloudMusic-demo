		...
		<view class="Search">
			...
			<view class="search-line">
				...
				<view class="search-box">
					...
					<input type="text" name="value" placeholder="歌曲/视频/歌单/电台/小说/歌词" class="ipt" placeholder-style="font-size: 20rpx" @click.stop="getsearch">
				</view>
				<view class="ke">
...
<script>
	...
	export default {
		...
		// onPullDownRefresh() {
		// 	this.isstart = false
		// 	getApp().globalData.bannerTitlePic = ''
		// 	getApp().globalData.bannerTitleSing = ''
		// 	getApp().globalData.bannerTitleIcon = ''
		// 	setTimeout(() => {
		// 		this.isstart = true
